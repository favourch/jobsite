...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th12 09, 2017 lúc 03:35 SA
...
(12, 0, 'Tư vấn trung tâm', 1, 0, '', 2, 1, 'vn'),
...
(28, 12, 'Chia sẻ kinh nghiệm phát triển nhân sự', 0, 0, '', 3, 1, 'vn'),
...
(29, 'Technical Sales Executive', 'Ammeraal Beltech an', 'là tập đoàn hàng đầu thế giới với hơn 65 năm kinh nghiệm trong lĩnh vực băng chuyền tải (belting). Sản phẩm và các giải pháp kỹ thuật của công ty được sử dụng rộng rãi trong nhiều ngành công nghiệp sản xuất, kho vận, hàng không, giấy ', 1449507600, 1510074000, 0, 3, 0, 0);
