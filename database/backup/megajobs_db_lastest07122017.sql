...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th12 07, 2017 lúc 11:32 SA
...
(3, 'Marketing', 'marketing', 5, 0),
(4, 'Chuyên viên sale', 'chuyen-vien-sale', 6, 0),
(5, 'Giáo viên tiểu học', 'giao-vien-tieu-hoc', 4, 0),
(6, 'Giáo viên TOEIC', 'giao-vien-toeic', 3, 0),
(7, 'Giáo viên IELT', 'giao-vien-ielt', 2, 0),
...
(1, 'Đại học ngoại ngữ', 1, 'Tiếng Anh', 0, 0, 3, 1242579600, 1272646800, 'Chưa có thành tựu gì trong học tập'),
...
INSERT INTO `member_candidates` (`id`, `email`, `password`, `created`, `full_name`, `gender`, `title`, `level_id`, `experience_id`, `nationality`, `image`, `birthday`, `city_id`, `phone`, `address`, `status`, `description`, `created_date`, `modified_date`, `facebook`, `google`, `cv_upload`) VALUES
(1, 'annt@lienketso.com.vn', 'e10adc3949ba59abbe56e057f20f883e', 1510305371, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2017-11-21 10:00:32', '2017-11-21 10:00:32', NULL, NULL, NULL),
(2, 'hoahh@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1510314455, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2017-11-21 10:00:32', '2017-11-21 10:00:32', NULL, NULL, NULL),
(3, 'thanhan1507@gmail.com', '96e79218965eb72c92a549dd5a330112', 1512646226, 'Nguyễn Thành An', 1, 'Lập trình viên PHP, UX/UI', 9, 3, 1, '13450307_1006073422841131_6687349337396034485_n.jpg', 616438800, 37, '0979823452', 'HH4C Linh Dam, Hoang Mai, Ha Noi', 1, 'I want become a professional php developer in vietnam, and i am php developer  Phân tích doanh số bán từng sản phẩm, lên kế hoạch chọn sản phẩm chạy chương trình khuyến mãi,\r\ntính giá khuyến mãi, theo dõi chỉnh sửa thông tin lên cẩm nang khuyến mãi. ', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, 'Resume-Maire-Jacobs-2017.pdf');
...
(2, 'annt@lienketso.vn', '1bd189600d9e9c257c7851b15a9cd037', 'Daian.,jsc', 'Tây Nam Linh Đàm, Hoàng Mai', '0439189898', 'http://dmit.vn', 1510304287, 1512404419, 0, 37, 6, 'Liên Kết Số sử dụng công nghệ thiết kế web chuyên nghiệp, thiết kế web nhanh chỉ trong vài giờ. Website được tối ưu với các công cụ tìm kiếm, Website tương thích với các thiết bị di động… Giao diện sang trọng, tiện dụng…Dễ dàng thay đổi theo phong cách ri', NULL, '0439189898', 'Trần Văn An', '0978523541', 'Phó giám đốc', 'annt@lienketso.vn'),
(3, 'hoahong@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Công Ty cổ phần liên kết số TDA', 'HH4C Linh Dam, Hoang Mai, Ha Noi', '0979823452', 'http://lienketso.com.vn', 1511882483, 1512235352, 0, 10, 7, 'Trung tâm sinh trắc vân tay vân tay việt là đơn vị đầu tiên đưa dịch vụ sinh trắc dấu vân tay từ ADRC, trung tâm nghiên cứu dấu vân tay Châu Á về Việt Nam, với hơn 3 năm kinh nghiệm triển khai dịch vụ, Vân tay việt tự hào là đơn vị cung cấp độc quyền dịch', 'company-logo05.jpg', '0979823452', 'Nguyễn Thành An', '0979823452', 'Hành chính nhân sự', 'thanhan1507@gmail.com');
...
(28, 'lập trình php .net', 'Công Ty TNHH Razona Việt Nam', 'Primary purpose: Achieve sales revenue assigned by the company by studying market need and trend, closely collaborating with others teams, managing team and resources to propose and deliver value-added solutions to existing and potential clients’ business. \nSupport Producer to identify new business opportunities or new services for clients.\n', '2013-09-12 00:00:00', '2017-02-08 00:00:00', 0, 3, 0, 0),
(29, 'Technical Sales Executive', 'Ammeraal Beltech an', 'là tập đoàn hàng đầu thế giới với hơn 65 năm kinh nghiệm trong lĩnh vực băng chuyền tải (belting). Sản phẩm và các giải pháp kỹ thuật của công ty được sử dụng rộng rãi trong nhiều ngành công nghiệp sản xuất, kho vận, hàng không, giấy ', '1970-08-01 00:00:00', '1970-01-01 00:00:00', 0, 3, 0, 0);
