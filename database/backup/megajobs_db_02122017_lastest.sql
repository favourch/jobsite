...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th12 02, 2017 lúc 11:22 SA
...
CREATE TABLE `recruitment` (
  ...
  `end_date` date DEFAULT NULL COMMENT 'ngày kết thúc đăng tin',
