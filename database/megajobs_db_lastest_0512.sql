...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th12 04, 2017 lúc 04:41 CH
...
(2, 'annt@lienketso.vn', 'e10adc3949ba59abbe56e057f20f883e', 'Daian.,jsc', 'Tây Nam Linh Đàm, Hoàng Mai', '0439189898', 'http://dmit.vn', 1510304287, 1512404419, 0, 37, 6, 'Liên Kết Số sử dụng công nghệ thiết kế web chuyên nghiệp, thiết kế web nhanh chỉ trong vài giờ. Website được tối ưu với các công cụ tìm kiếm, Website tương thích với các thiết bị di động… Giao diện sang trọng, tiện dụng…Dễ dàng thay đổi theo phong cách ri', NULL, '0439189898', 'Trần Văn An', '0978523541', 'Phó giám đốc', 'annt@lienketso.vn'),
...
(9, 'Nhân Viên Tín Dụng - Làm Việc Tại Văn Phòng.', 'nhan-vien-tin-dung---lam-viec-tai-van-phong', '- Bạn đang tìm kiếm công việc phù hợp?\r\n- Bạn là sinh viên mới ra trường và chưa tìm được công việc có thu nhập tốt. Bạn đã có kinh nghiệm “chinh chiến” nhưng muốn thay đổi “mặt trận” và vị trí “chiến đấu” mới\r\n-Tin vui không thể bỏ lỡ: 10 VỊ TRÍ TELEMARKETING CẦN ĐẾN BẠN\r\n- Tham gia ngay biệt đội chiến đấu ngay thôi vì:\r\n- Thu nhập = lương cứng + hoa hồng + thưởng, bình quân 5-9 triệu /tháng, nếu làm tốt hơn có thể nhận cao hơn.\r\n- Thưởng nóng cho nhân viên có thành tích xuất sắc, cơ hội thăng tiến lên các vị trí giám sát\r\n- Danh sách khách hàng luôn có sẵn\r\n- Bạn được đào tạo toàn diện về kỹ năng và nghiệp vụ chuyên sâu, được hỗ trợ chi phí hoàn toàn 100%.\r\n- Môi trường hiện đại: điều hòa mát lạnh, ánh sáng chan hòa, phòng họp, phòng ăn đầm ấm, vui vẻ. Được tham gia các hoạt động team building, văn hóa văn nghệ giàu bản sắc của công ty. \r\nHOT: CÓ TUYỂN NHÂN VIÊN LÀM PART TIME', 5, 8, 7, 46, 9, 20, '- Chế độ đầy đủ, BHXH, BHYT \r\n- Lương cơ bản + hoa hồng cao\r\n- Du lịch hằng năm\r\n- Thăng tiến nhanh', '- Tuổi từ 18, Tốt nghiệp THPT trở lên.\r\n- Giọng nói dễ nghe, rõ ràng, truyền đạt được thông tin.\r\n- Nhanh nhẹn, Trách nhiệm, biết lắng nghe.\r\n- Có vẻ bạn đã thích thú rồi phải không? Hãy chọn 1 trong những cách dưới đây để liên hệ với chúng tôi nhé:', '- Đơn xin việc.\r\n- Sơ yếu lý lịch.\r\n- Hộ khẩu, chứng minh nhân dân và giấy khám sức khỏe.\r\n- Các bằng cấp có liên quan.', 1, 0, 1512404275, 1513184400, 4, 4, 1, 2, 0, NULL, 1);
