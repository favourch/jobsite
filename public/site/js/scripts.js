(function ($) {
	...
	if( $('.header-inner').hasClass( "has-form" ) )
	{
			...
			var mapOptions = {
				...
				draggable: false,
			 	styles: [
				  ...
				  {
				    "elementType": "http://jobpress.wecookcode.com/demo/js/labels.icon",
				    "stylers": [
				      {
				        "visibility": "off"
				      }
				  ...
				  {
				    "elementType": "http://jobpress.wecookcode.com/demo/js/labels.text",
				    "stylers": [
				      {
				        "color": "#588b93"
				      }
				  ...
				  {
				    "elementType": "http://jobpress.wecookcode.com/demo/js/labels.text.fill",
				    "stylers": [
				      {
				        "color": "#588b93"
				      }
				  ...
				  {
				    "featureType": "http://jobpress.wecookcode.com/demo/js/poi.park",
				    "elementType": "http://jobpress.wecookcode.com/demo/js/geometry.fill",
				    "stylers": [
				      {
				        "color": "#d3e1c4"
				      }
				  ...
				  {
				    "featureType": "http://jobpress.wecookcode.com/demo/js/transit.line",
				    "elementType": "geometry",
				    "stylers": [
				      {
				        "color": "#dfd2ae"
