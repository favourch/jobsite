		...
		<div class="section candidate-dashboard-content solid-light-grey-bg">
						...
						<div class="right-side-content">
						 ...
						 <div id="notifications" class="tab-pane fade in active">
							        ...
							        <div class="notifications-list-wrapper">
							        	...
							        	<?php $city = $this->city_model->get_info($company->city_id); ?>
			...
			<img src="<?php echo base_url('uploads/company/'.$company->logo_url); ?>" alt="" class="img-responsive">
											...
											<div class="notification-text">
												<p><b><a href="#"><?php echo $company->company_name; ?></a></b> </p>
											<span class="company-name"><?php echo $city->name; ?></span>
												<p class="ultra-light">Xem lúc : <?php echo int_to_date($row->created); ?></p>
