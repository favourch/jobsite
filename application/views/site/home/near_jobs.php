	...
	<button onclick="calc_location()">Try It</button>
...
$(".careerfiel").on("change", function () {		
		...
		error:function (xhr, ajaxOptions, thrownError){
            ...
            <option value="<?php echo $row->id; ?>" data-latitude="<?php echo $row->latitude; ?>" data-longitude="<?php echo $row->longitude; ?>"><?php echo $row->name; ?></option>
             <?php endforeach; ?>
             </select>
                    </div>
...
function calc_location(){
	//var origin1 = new google.maps.LatLng(55.930385, -3.118425);
var origin2 = 'Ho Chi Minh City, Vietnam';
var destinationA = 'Hanoi, Vietnam';
