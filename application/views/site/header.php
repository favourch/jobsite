                ...
                <div class="header-inner flex space-between items-center">
                    ...
                    <div class="right flex space-between no-column items-center">
                        ...
                        <div class="button-group-merged flex no-column">
                            <a href="#login" data-toggle="modal" data-target=".bs-modal-sm" class="button">Đăng nhập</a>
                            <a href="<?php echo base_url('member_register/register'); ?>" class="button">Đăng ký</a>
                ...
                <div class="modal-content">
                    <div class="popup-tabs">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            <li class="active"><a data-toggle="tab" href="#register">Đăng ký</a></li>
                        </ul>
                    </div> <!-- end .popup-tabs -->
                    <div class="modal-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade" id="login">
                                <form class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label for="InputEmail1">Email của bạn *</label>
                                        <input type="email" name="email" class="form-control" id="InputEmail1" placeholder="Enter your email">
                                    </div>
                                    ...
                                    <div class="checkbox flex space-between">
                                        <div>
                                            ...
                                            <label for="sigin-checkbox">Nhớ mật khẩu</label>
                                        </div>
                            ...
                            <div class="tab-pane fade active in" id="register">
                                ...
                                <form class="signup-form" method="post" action="<?php echo base_url('member_company/register'); ?>">
                                    <div class="form-group">
                                        <label for="InputEmail1">Email *</label>
                                        <input type="email" name="email" class="form-control" id="InputEmail2" placeholder="Enter your email">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="repassword" class="form-control" id="InputPassword3" placeholder="Password">
                                    </div>

                                    <div class="form-group">
                                        <label for="select1">Đăng ký cho :</label>
                                        <div class="select-wrapper">
                                            <select class="form-control" name="member_name" id="select1">
                                                <option value="ungvien">Ứng viên</option>
                                                <option value="tuyendung">Nhà tuyển dụng</option>
                                            </select>
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label for="signup-checkbox">Tôi đồng ý với điều khoản trên</label>
                                    </div> <!-- end .checkbox -->

                                    <input type="submit" value="Đăng ký" class="button">
                                    
                                    <p class="text-center divider-text small"><span>Hoặc đăng nhập với</span></p>
