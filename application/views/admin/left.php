			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo admin_url('category'); ?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Danh mục sản phẩm</span></a></li>
						...
						<li><a href="<?php echo admin_url('admin'); ?>"><i class="icon-lock"></i><span class="hidden-tablet"> Tài khoản</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
