	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Danh sách quảng cáo</h2>
						<div class="box-icon">
				...
				<a href="<?php echo admin_url('adver/add'); ?>" class="btn btn-small btn-success"><i class="halflings-icon white plus"></i> Thêm mới</a>
				...
				<form name="theForm" id="theForm" action="<?php echo admin_url('adver/delete_all'); ?>" method="post">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						 ...
						 <?php foreach($list as $row) : ?>
							<tr class="row_<?php echo $row->id; ?>">
								...
								<td class="center"><img src="<?php echo base_url('uploads/adver/'.$row->image) ?>" width="70"></td>
								<td><?php echo $row->link; ?></td>
								<td class="center">
								<select disabled="">
									<?php echo get_adver_status(1,$row->status); ?>
								</select>
								</td>
								<td class="center">
					<a class="btn btn-small btn-info" href="<?php echo admin_url('adver/edit/'.$row->id); ?>">
					<i class="halflings-icon white edit"></i>  
					</a>
					<a class="btn btn-small btn-danger" href="<?php echo admin_url('adver/del/'.$row->id); ?>" onclick="return check_del();">
