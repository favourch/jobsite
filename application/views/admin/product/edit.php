					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" for="">Số điểm cộng</label>
							  <div class="controls">
								<input type="text" class="span6" name="scores" value="<?php echo $info->scores; ?>" >
								<div class="help-block"><?php echo form_error('scores'); ?></div>
							  </div>
							</div>
					
							<div class="control-group">
							  <label class="control-label" for="">Mô tả dịch vụ </label>
							  <div class="controls">
								<textarea class="span6" name="intro" id="editor1"><?php echo $info->intro; ?></textarea>
