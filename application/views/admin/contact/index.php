	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Danh sách tin nhắn</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php foreach($list as $row) : ?>
							<tr>
								...
								<?php else: ?>
								<span class="label label-important">Chưa trả lời</span>
								<?php endif; ?>
								</td>
								<td class="center">
					<a class="btn btn-small btn-info" href="<?php echo admin_url('contact/view/'.$row->id); ?>">
					<i class="halflings-icon white folder-open"></i>  
					</a>
					<a class="btn btn-small btn-danger" href="<?php echo admin_url('contact/del/'.$row->id); ?>" onclick="return check_del();">
