...
<ul class="breadcrumb">
				...
				<li><a href="#">Quản lý trang tin</a></li>
			</ul>
...
<script type="text/javascript">
	function resetall(){
		window.location.href= <?php echo admin_url('page'); ?>
	}
</script>
...
<a class="btn btn-small btn-inverse" href="javascript:void(0)" onclick="return resetall();">Reset</a>
	...
	<div class="row-fluid sortable">		
				...
				<a href="<?php echo admin_url('page/add'); ?>" class="btn btn-small btn-success"><i class="halflings-icon white plus"></i> Thêm mới</a>
				...
				<form name="theForm" id="theForm" action="<?php echo admin_url('page/delete_all'); ?>" method="post">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						 ...
						 <?php foreach($list as $row) : ?>
							<tr class="row_<?php echo $row->id; ?>">
								...
								<td class="center">
					<a class="btn btn-small btn-info" href="<?php echo admin_url('page/edit/'.$row->id); ?>">
					<i class="halflings-icon white edit"></i>  
					</a>
					<a class="btn btn-small btn-danger" href="<?php echo admin_url('page/del/'.$row->id); ?>" onclick="return check_del();">
