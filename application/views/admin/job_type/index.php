...
<ul class="breadcrumb">
				...
				<li><a href="#">Quản lý loại công việc</a></li>
			</ul>
	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Danh sách loại công việc</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						 ...
						 <?php foreach($list as $row) : ?>
							<tr class="row_<?php echo $row->id; ?>">
								...
								<td class="center">
					<a class="btn btn-small btn-info" href="<?php echo admin_url('job_type/edit/'.$row->id); ?>">
					<i class="halflings-icon white edit"></i>  
					</a>
					<a class="btn btn-small btn-danger" href="<?php echo admin_url('job_type/del/'.$row->id); ?>" onclick="return check_del();">
